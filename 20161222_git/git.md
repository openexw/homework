...
# 将web提交到本地仓库
git commit -m "第一次提交"   #将添加的文件提交的仓库并注释为“提交”



# 新建github仓库
git remote add files https://github.com/zhou1996/files.git    
#添加origin的github地址


# 将本地的仓库存推送到github
git push files master  #将本地仓库用master分支推送到github上
...
git commit -m "第三次提交"       #提交修改后的文件
git push files master      #将文件夹推送到github上
...
git commit -m "第四次提交"    #把文件提交到仓库
git push files dev         #使用dev分支把仓库文件推送到github上
...
git push files master      #推送到github上
...
# 将新建的标签推送到github
git push files --tags      #将所有未推送的标签推送到github上
